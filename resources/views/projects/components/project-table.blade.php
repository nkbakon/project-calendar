<div class="overflow-x-auto">
    <div class="flex w-full p-3 space-x-2">
        ...
        <div class="w-3/6">
            ...
            focus:outline-none focus:shadow-outline focus-ring-0 foucus:bg-indigo-50" placeholder="Search Projects...">
        </div>
        <!-- Order By -->
        <div class="w-1/6">
    ...
    <table class="w-full text-base text-left text-gray-700 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">                                    
                ...
                <td class="hidden">
                    {{ $project->addby->username }}
                </td>
                <td class="hidden">
                    {{ $project->created_at->format('Y-m-d') }}
                </td>
                <td class="hidden">
                    {{ $project->editby->username }}
                </td>
                <td class="hidden">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6">
                ...
                <div>
                    ...
                    <strong>Start Date : </strong><span id="view_start"></span><br>
                    <strong>Due Date : </strong><span id="view_due"></span> (<span id="view_diff"></span>)<br>  
                    <strong>Note : </strong><span id="view_note"></span><br>
                    <strong>Add By : </strong><span id="view_addby"></span><br>
                    <strong>Add Date : </strong><span id="view_adddate"></span><br>
                    <strong>Last Edit By : </strong><span id="view_editby"></span><br>
                    <strong>Last Edit Date : </strong><span id="view_editdate"></span><br>
                </div>                                
            </div>
        </div>
    </div>
    ...
    <div class="relative w-full h-full max-w-md md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 text-center">
                <form method="POST" action="{{ route('projects.destroy', 'data_id') }}">
                    @csrf
                    @method('DELETE')
...
<script>
    ...
    $(document).ready(function(){
        $('.viewBtn').on('click', function(){
            ...
            document.getElementById('view_start').innerHTML = data[2];
            document.getElementById('view_due').innerHTML = data[3];
            document.getElementById('view_diff').innerHTML = data[4];
            document.getElementById('view_note').innerHTML = data[5];
            document.getElementById('view_addby').innerHTML = data[6];
            document.getElementById('view_adddate').innerHTML = data[7];
            document.getElementById('view_editby').innerHTML = data[8];
            document.getElementById('view_editdate').innerHTML = data[9];
